...
class thepiratebay_top1004ktv(object):
    url = 'https://thepiratebay.org/'
    api_url = "https://apibay.org/"
    name = 'TPB Top 100 4K TV'
    ...
    def search(self, what, cat='all'):
        # Always fetch Top 100 4K TV, ignore search query
        url = '{0}precompiled/data_top100_212.json'.format(self.api_url)
