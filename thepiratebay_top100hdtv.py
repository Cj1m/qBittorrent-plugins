...
class thepiratebay_top100hdtv(object):
    url = 'https://thepiratebay.org/'
    api_url = "https://apibay.org/"
    name = 'TPB Top 100 HD TV'
    ...
    def search(self, what, cat='all'):
        # Always fetch Top 100 HD TV, ignore search query
        url = '{0}precompiled/data_top100_208.json'.format(self.api_url)
