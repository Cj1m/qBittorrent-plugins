...
class thepiratebay_top1004kmovies(object):
    url = 'https://thepiratebay.org/'
    api_url = "https://apibay.org/"
    name = 'TPB Top 100 4K Movies'
    ...
    def search(self, what, cat='all'):
        # Always fetch Top 100 4K Movies, ignore search query
        url = '{0}precompiled/data_top100_211.json'.format(self.api_url)
